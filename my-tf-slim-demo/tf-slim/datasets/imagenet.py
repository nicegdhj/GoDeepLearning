...
Some maybe_images have one or more bounding boxes associated with the label of the
...
For each synset, there are on average 150 maybe_images with bounding boxes."
...
def get_split(split_name, dataset_dir, file_pattern=None, reader=None):
  ...
  Args:
    split_name: A train_data/test split name.
  ...
  Raises:
    ValueError: if `split_name` is not a valid train_data/test split.
  """
